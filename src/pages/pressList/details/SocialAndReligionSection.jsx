...
function SocialAndReligionSection({
  handleClick,
  handleClickTelegram,
  searchValue,
}) {
  ...
  const getData = async (page = 1) => {
    try {
      ...
      const respons = await axios.get(
        `maqolalar/?page=${page}&limit=15&type=Ijtimoiy_masalalar_va_din&search=${searchValue}`,
        {
          headers: {
...
export default React.memo(SocialAndReligionSection);
