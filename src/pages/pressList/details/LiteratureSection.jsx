...
function LiteratureSection({ handleClick, handleClickTelegram, searchValue }) {
  ...
  const getData = async (page = 1) => {
    try {
      ...
      const respons = await axios.get(
        `maqolalar/?page=${page}&limit=15&type=Adabiyot&search=${searchValue}`,
        {
          headers: {
...
export default React.memo(LiteratureSection);
