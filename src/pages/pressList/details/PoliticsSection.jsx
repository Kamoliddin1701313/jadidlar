...
function PoliticsSection({ handleClick, handleClickTelegram, searchValue }) {
  ...
  const getData = async (page = 1) => {
    try {
      ...
      const respons = await axios.get(
        `maqolalar/?page=${page}&limit=15&type=Siyosat&search=${searchValue}`,
        {
          headers: {
...
export default React.memo(PoliticsSection);
